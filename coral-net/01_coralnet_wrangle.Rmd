...
#Count number of unique observation type (organism/benthos type etc.) in your dataset i.e. get a list of the organisms you saw across all your photos:
...
#Now you can see we are now left with 11 columns
