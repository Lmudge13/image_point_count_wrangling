...
Note: your metadata columns might have some different names, but as on the metadata you entered into CoralNet. Here, we give an example of metadata that includes site and transect, as these are commonly used metrics for analyzing data  
